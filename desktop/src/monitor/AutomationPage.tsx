import { AIDeviceControl } from "../components/AIDeviceControl";
...
export function AutomationPage({ saveDir, channels = [], onOpenSettings, aiDevice, onAIDeviceChange, aiConcurrency, onAIConcurrencyChange, runtimeEnabled = isTauri(), hidden = false }: {
  aiDevice?: AIDevicePreference; onAIDeviceChange?: (value: AIDevicePreference) => Promise<void>;
