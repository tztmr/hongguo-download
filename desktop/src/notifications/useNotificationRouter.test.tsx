...
function youtubeFixture(): YouTubeModel {
  return {
    ...
    importCredential: vi.fn(), authorize: vi.fn(), setChannel: vi.fn(), revoke: vi.fn(), removeCredential: vi.fn(), startUpload: vi.fn(), cancel: vi.fn(), pause: vi.fn(), resume: vi.fn(), retry: vi.fn(), retryThumbnail: vi.fn(), uploadSubtitle: vi.fn(), removeJob: vi.fn(),
    markNotified: vi.fn().mockResolvedValue(undefined),
  };
}
