...
export const youtubeCommands: YouTubeCommands = {
  ...
  pause: (jobId) => invoke<YouTubeJob>("pause_youtube_upload_job", { jobId }),
  ...
  uploadSubtitle: (jobId, request) => invoke<YouTubeJob>("upload_youtube_subtitle", { jobId, request: request ?? null }),
